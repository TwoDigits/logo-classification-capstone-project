...
%\centering
\caption{Architecture of a first CNN for logo classification from Keras \cite{chollet2015keras}.}\\
    \hline
    Layer (type) & Output Shape & Param \# \\
    \hline
    \endfirsthead
...
Now we continue to build a custom Keras CNN model on top of the well-known VGG16 architecture \cite{DBLP:journals/corr/SimonyanZ14a}: 
...
\begin{longtable}{ccc}%[htb!]
\caption{Architecture of the VGG16 model  \cite{DBLP:journals/corr/SimonyanZ14a} from Keras \cite{chollet2015keras}.}\\
    \hline
    Layer (type) & Output Shape & Param \# \\
    \hline
    \endfirsthead
